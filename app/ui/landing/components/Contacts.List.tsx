...
export const ContactsList = ({
  ...
  return (
    <div className={cn(wrapperClasses)}>
      ...
      >
        <ContactIcon
          imgProps={{ src: "/icons/whatsapp.svg", alt: "Whatsapp icon", className:"invert" }}
        />
        <ContactIcon
          imgProps={{ src: "/icons/phone.svg", alt: "Phone icon", className:"invert" }}
        />
      ...
      <a
        ...
        className={"flex gap-2 cursor-pointer"}
      >
        <ContactIcon imgProps={{ src: "/icons/mail.svg", alt: "Email icon", className:"invert" }} />
